...
OptionsParser::OptionsParser() :
	...
	desc.add_options()("help,h", "produce help message")("nevt,n",
			po::value<int>(), "max number of events")("file,i",
			...
			"Activate verbose debugging")("filter,f", po::value<std::string>(),
			"Filter file")("dooutput", po::value<bool>()->default_value(false),
			...
			"cuts,c", po::value<std::string>(), "Cuts file")("eall,e",
			po::value<bool>()->default_value(false),
			"Export all events, even failed");
}
