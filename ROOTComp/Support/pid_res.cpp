...
void printResStruct(struct alt_pid_res &pid_res, struct alt_pid_res *pid_res_2){
	...
	if(pid_res_2) std::cout << "Total: \t\t\t" << printDiv(pid_res_2->total.events[0], pid_res_2->total.events[0]) << std::endl;
	std::cout << "|-Prelim: \t\t" << printDiv(pid_res.total.prelim.events[0], pid_res.total.events[0], pid_res.total.prelim.events[0]) << std::endl;
	if(pid_res_2) std::cout << "|-Prelim: \t\t" << printDiv(pid_res_2->total.prelim.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0]) << std::endl;
	std::cout << "  |-NoID: \t\t" << printDiv(pid_res.total.prelim.noID.events[0], pid_res.total.events[0], pid_res.total.prelim.events[0]) << std::endl;
	if(pid_res_2) std::cout << "  |-NoID: \t\t" << printDiv(pid_res_2->total.prelim.noID.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0]) << std::endl;
	...
	if(pid_res_2) std::cout << "  |-ManyID: \t\t" << printDiv(pid_res_2->total.prelim.manyID.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0]) << std::endl;
	...
	if(pid_res_2) std::cout << "  |-Ided: \t\t" << printDiv(pid_res_2->total.prelim.ided.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0], pid_res_2->total.prelim.ided.events[0]) << std::endl;
	...
	if(pid_res_2) std::cout << "    |-Pass: \t\t" << printDiv(pid_res_2->total.prelim.ided.pass.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0], pid_res_2->total.prelim.ided.events[0]) << std::endl;
	...
	if(pid_res_2) std::cout << "    |-NoPass: \t\t" << printDiv(pid_res_2->total.prelim.ided.noPass.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0], pid_res_2->total.prelim.ided.events[0]) << std::endl;
	...
	if(pid_res_2) std::cout << "  |-Associated: \t" << printDiv(pid_res_2->total.prelim.associated.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0], pid_res_2->total.prelim.associated.events[0]) << std::endl;
	...
	if(pid_res_2) std::cout << "  | |-NoID: \t\t" << printDiv(pid_res_2->total.prelim.associated.noID.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0], pid_res_2->total.prelim.associated.events[0]) << std::endl;
	...
	if(pid_res_2) std::cout << "  | |-ManyID: \t\t" << printDiv(pid_res_2->total.prelim.associated.manyID.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0], pid_res_2->total.prelim.associated.events[0]) << std::endl;
	...
	if(pid_res_2) std::cout << "  | |-Ided: \t\t" << printDiv(pid_res_2->total.prelim.associated.ided.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0], pid_res_2->total.prelim.associated.events[0], pid_res_2->total.prelim.associated.ided.events[0]) << std::endl;
	...
	if(pid_res_2) std::cout << "  |   |-Good: \t\t" << printDiv(pid_res_2->total.prelim.associated.ided.good.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0], pid_res_2->total.prelim.associated.events[0], pid_res_2->total.prelim.associated.ided.events[0], pid_res_2->total.prelim.associated.ided.good.events[0]) << std::endl;
	...
	if(pid_res_2) std::cout << "  |   | |-Pass: \t" << printDiv(pid_res_2->total.prelim.associated.ided.good.pass.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0], pid_res_2->total.prelim.associated.events[0], pid_res_2->total.prelim.associated.ided.events[0], pid_res_2->total.prelim.associated.ided.good.events[0]) << std::endl;
	...
	if(pid_res_2) std::cout << "  |   | |-NoPass: \t" << printDiv(pid_res_2->total.prelim.associated.ided.good.noPass.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0], pid_res_2->total.prelim.associated.events[0], pid_res_2->total.prelim.associated.ided.events[0], pid_res_2->total.prelim.associated.ided.good.events[0]) << std::endl;
	...
	if(pid_res_2) std::cout << "  |   |-Bad: \t\t" << printDiv(pid_res_2->total.prelim.associated.ided.bad.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0], pid_res_2->total.prelim.associated.events[0], pid_res_2->total.prelim.associated.ided.events[0], pid_res_2->total.prelim.associated.ided.bad.events[0]) << std::endl;
	...
	if(pid_res_2) std::cout << "  |     |-Pass: \t" << printDiv(pid_res_2->total.prelim.associated.ided.bad.pass.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0], pid_res_2->total.prelim.associated.events[0], pid_res_2->total.prelim.associated.ided.events[0], pid_res_2->total.prelim.associated.ided.bad.events[0]) << std::endl;
	...
	if(pid_res_2) std::cout << "  |     |-NoPass: \t" << printDiv(pid_res_2->total.prelim.associated.ided.bad.noPass.events[0], pid_res_2->total.events[0], pid_res_2->total.prelim.events[0], pid_res_2->total.prelim.associated.events[0], pid_res_2->total.prelim.associated.ided.events[0], pid_res_2->total.prelim.associated.ided.bad.events[0]) << std::endl;
}
